...
CFLAGS		+=	$(INCLUDE) -D__3DS__ -I$(CTRPFLIB)/include
...
export LIBPATHS	:=	$(foreach dir,$(LIBDIRS),-L$(dir)/lib) -L$(CTRPFLIB)/lib
...
$(BUILD):
	...
	$(MAKE) --no-print-directory -C $(CURDIR)/$(BUILD) -f $(CURDIR)/Makefile all
